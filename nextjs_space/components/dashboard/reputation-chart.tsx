...
export default function ReputationChart({ period }: ReputationChartProps) {
  ...
  const fetchData = async () => {
    try {
      const res = await fetch(`/api/dashboard/reputation?period=${period}`)
      if (res.ok) {
